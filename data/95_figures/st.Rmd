...
Figure S9. Relative distribution of selected motifs in gene promoters/terminators.  The promoter/terminator (-/+2k:TSS,-/+2k:TTS) regions of different co-expression clusters (all heat up-regulated, heat early activation, or background gene set ('bg')) were cut into 40 bins.  The occurrence of selected motifs in these bins were recorded and the proportion of genes contains the motif in each bin is plotted.
